...
别问我这段时间干啥了，偷偷修仙去了（滑稽）。之前想尝试的搭建一个hexo博客的，但是在阿里

上面租的那台服务器带宽才1m，部署是部署好了，但是处理一些图片还是有点慢，所以想想

还是直接在GitHub上面写日志就好了！！！

这几天主要是花时间去考了阿里的一个ACA认证。花了大概一个星期左右吧。还是蛮简单的，

看看视频基本就会了，讲得挺详细的。也不知道后面公司会不会看这个证书，反正证书

多一个证书也就是锦上添花是吧！（滑稽）

今天我主要学习的内容是KVM,基于内核的虚拟机（KVM）是Linux®中内置的一种开源虚拟

化技术。具体来说，KVM使您可以将Linux变成虚拟机监控程序，该虚拟机管理程序允许

主机运行多个独立的虚拟环境.


--------------------------------[KVM](https://github.com/zyiqian/Mylogs.github.io/blob/master/KVM/KVM%E9%83%A8%E7%BD%B2%E5%AE%9E%E4%BE%8B/kvm.md)----------------------
---
---
2019-10-27

今天是周末，因为过于无聊然后上某就业平台看了下云计算岗位的基本需求；我大概浏览了三四十家企业吧

发现他们这个云计算岗位的技术需求基本都是差不多的，然后我总结了下各个企业的重要技术需求；

发现在我们所学的课程之中都是有的，这个是比较好的。想要学得更好还是需要自己花时间去扩展，

基本需求技术我都总结出来了，会有点不全，但是能够学完这些内容已经是很不错了！！！！

--------------------------------[云计算岗位的基本需求](https://github.com/Shmil-You/Mylogs.github.io/blob/master/My_Logs/%E4%BA%91%E8%AE%A1%E7%AE%97%E5%B7%A5%E4%BD%9C%E5%B2%97%E4%BD%8D%E5%9F%BA%E6%9C%AC%E9%9C%80%E6%B1%82.md)----------------------
---
---
2019-10-22
...
今天主要是对虚拟机的磁盘做了LV扩容，对Python前面的一些内容做了些复习，十天的Python学习，感觉就是一晃就过了...

好像啥也没学到的样子，我太low了，完全不在状态啊...........

还有一个多月的时间就要出去工作，还是压力蛮大的。要炸了.........

我要改变..................................................个锤子。

--------------------------------[LV扩容](https://github.com/Shmil-You/Mylogs.github.io/blob/master/My_Logs/Linux%E6%89%A9%E5%AE%B9.md)------------------------
---
2019-10-18
...
今天让我对身体素质及健康有了深刻的理解，身体才是革命的本钱嘛，只有把身体搞好了
