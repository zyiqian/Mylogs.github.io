...
今天对昨天的12306抢票做了linux版本的文档，这也是一时兴起，觉得在Windows系统上面跑是要比linux下面耗内存更大些
所以特此又做了Linux版的,文档在--MyLog--目录下，有兴趣的小伙伴可以尝试下
...
今天绝大部分时间我都用在了分析12306抢票的上面，因为临近十一了，很多好友都抢不到票，所以想借此机会秀一手。
